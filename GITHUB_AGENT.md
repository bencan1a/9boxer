...
> **For comprehensive technical guidance:** See [CLAUDE.md](CLAUDE.md) - complete reference  
> **For quick-start checklist:** See [AGENTS.md](AGENTS.md) - minimal workflow guide
...
2. **GITHUB_AGENT.md** - This file (quick onboarding)
3. **CLAUDE.md** - Detailed technical guidance
4. **AGENTS.md** - Development workflow checklist
...
**For complete technical guidance, see [CLAUDE.md](CLAUDE.md)**
