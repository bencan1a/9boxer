...
def upload_sample_data_with_flags(
    ...
    # Data rows
    employees = [
        (1, "Alice", "Engineer", "Software Engineer", "Software EngineeringUSA", "MT4", "Manager", "2020-01-01", "3-5 years", "2 years", "High", "High", "Yes"),
        (2, "Bob", "Engineer", "Software Engineer", "Software EngineeringUSA", "MT3", "Manager", "2021-01-01", "1-3 years", "1 year", "Medium", "Medium", "No"),
        (3, "Charlie", "Engineer", "Software Engineer", "Software EngineeringUSA", "MT2", "Manager", "2022-01-01", "0-1 year", "6 months", "Low", "Low", "No"),
    ]
