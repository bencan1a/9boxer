...
def test_position_calculation_when_all_9_grid_positions_then_correct(
    ...
    assert session_manager._calculate_position(PerformanceLevel.LOW, PotentialLevel.MEDIUM) == 2
    assert session_manager._calculate_position(PerformanceLevel.LOW, PotentialLevel.HIGH) == 3

    # Medium performance
    assert session_manager._calculate_position(PerformanceLevel.MEDIUM, PotentialLevel.LOW) == 4
    assert session_manager._calculate_position(PerformanceLevel.MEDIUM, PotentialLevel.MEDIUM) == 5
    assert session_manager._calculate_position(PerformanceLevel.MEDIUM, PotentialLevel.HIGH) == 6

    # High performance
    assert session_manager._calculate_position(PerformanceLevel.HIGH, PotentialLevel.LOW) == 7
    assert session_manager._calculate_position(PerformanceLevel.HIGH, PotentialLevel.MEDIUM) == 8
