...
![Empty state screen showing the Load Sample Data button](/images/screenshots/quickstart/quickstart-empty-state-sample-button.png)
...
![Grid populated with sample employee data](/images/screenshots/quickstart/quickstart-grid-populated.png)
...
![Employee details panel showing job info and reporting chain](/images/screenshots/quickstart/quickstart-employee-details-with-history.png)
...
![Employee tile with orange left border indicating modification](/images/screenshots/workflow/making-changes-orange-border.png)
...
![Statistics panel showing distribution](/images/screenshots/statistics/statistics-panel-distribution.png)
