...
![File menu button in the application toolbar, showing 'No file selected' state](images/screenshots/quickstart/quickstart-file-menu-button.png)
...
![Annotated screenshot showing successful upload state with three callouts](images/screenshots/quickstart/quickstart-success-annotated.png)
