...
You'll want to work with individual employees when:

- **Reviewing performance details** - Check an employee's job level, manager, and organizational chain before making decisions
- **Making rating changes** - Drag employees to new boxes and verify the change with visual feedback ([see Making Your First Changes](workflows/making-changes.md))
- **Checking movement history** - View timeline to see when and why an employee's rating changed over time
- **During one-on-one reviews** - Pull up employee details to discuss performance and potential with their manager
- **Verifying placements** - Click employees to confirm they're in the correct box with accurate data
...
4. The tile gets an **orange left border** to indicate it's been modified
...
- An orange left border appears on the modified employee tile
