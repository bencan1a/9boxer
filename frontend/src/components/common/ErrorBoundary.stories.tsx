  ...
  return (
    <Box sx={{ padding: 3, textAlign: 'center' }}>
      ...
      <Typography variant="body1" color="text.secondary">
        This content is displayed when there are no errors. The ErrorBoundary wraps this component
        and will catch any rendering errors that occur.
      </Typography>
    </Box>
  );
};
      ...
      {!shouldThrow && (
        <Box sx={{ padding: 3, textAlign: 'center' }}>
          ...
          <Typography variant="body1" color="text.secondary" paragraph>
            Click the button below to simulate a component error. The ErrorBoundary will catch it
            and display the error UI.
          </Typography>
  ...
  render: () => (
    <ErrorBoundary>
      <Box sx={{ padding: 3, textAlign: 'center' }}>
        ...
        <Typography variant="body1" color="text.secondary">
          When there are no errors, the ErrorBoundary simply renders its children as-is. It acts as
          a safety net that only activates when a component error occurs.
        </Typography>
      </Box>
    </ErrorBoundary>
  ),
