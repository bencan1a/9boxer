...
export const LongFields: Story = {
  args: {
    employee: {
      ...
      business_title: 'Chief Distinguished Principal Senior Staff Software Architect and Technical Fellow',
...
export const LowPerformer: Story = {
  args: {
    employee: {
      ...
      development_action: 'Weekly coaching sessions and structured development plan',
      ratings_history: [],
    },
  },
};
