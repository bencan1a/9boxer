...
describe('StatisticsTab', () => {
  it('displays statistics when data is loaded', () => {
    ...
    expect(screen.getByText(getTranslatedText('panel.statisticsTab.totalEmployees'))).toBeInTheDocument()
    expect(screen.getByText(getTranslatedText('panel.statisticsTab.modified'))).toBeInTheDocument()
    expect(screen.getByText(getTranslatedText('panel.statisticsTab.highPerformers'))).toBeInTheDocument()
  })
  ...
  it('renders distribution table', () => {
    ...
    // Check table headers
    expect(screen.getByText(getTranslatedText('panel.statisticsTab.position'))).toBeInTheDocument()
    expect(screen.getByText(getTranslatedText('panel.statisticsTab.count'))).toBeInTheDocument()
    expect(screen.getByText(getTranslatedText('panel.statisticsTab.percentage'))).toBeInTheDocument()
  })
