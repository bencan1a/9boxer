...
![Three-panel sequence showing: 1) clicking on an employee tile, 2) dragging it across the grid, 3) dropping it in the new position](../images/screenshots/making-changes-drag-sequence.png)
...
![Employee details panel showing updated Performance and Potential ratings](../images/screenshots/making-changes-employee-details.png)
...
![Timeline view showing the employee's current position and historical ratings](../images/screenshots/making-changes-timeline.png)
...
![Changes tab showing a table of all employee movements with old and new positions](../images/screenshots/making-changes-changes-tab.png)
