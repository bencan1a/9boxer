...
![Sample Excel file showing the 4 required columns highlighted](images/screenshots/quickstart-excel-sample.png)
...
![File upload dialog showing file selection and Import button](images/screenshots/quickstart-upload-dialog.png)

### Watch the Magic Happen

Your employees automatically appear on the grid, positioned based on their performance and potential ratings.

![Grid populated with employee tiles after successful upload](images/screenshots/quickstart-grid-populated.png)
...
![Annotated screenshot showing successful upload state with three callouts](images/screenshots/quickstart-success-annotated.png)
