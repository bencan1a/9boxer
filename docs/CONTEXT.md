...
**Generated**: 2025-12-24T03:37:08.540369+00:00
...
```json
{
  ...
  "agent_onboarding": {
    ...
    "documentation_hierarchy": {
      "highest_authority": "docs/facts.json (this file)",
      "permanent_docs": "docs/ directory",
      "active_plans": "agent-projects/ (hints only, <21 days old)",
      "auto_generated": "docs/_generated/ (regenerated automatically)"
    },
    "quick_commands": {
